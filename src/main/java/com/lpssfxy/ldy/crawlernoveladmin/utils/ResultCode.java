...
public enum ResultCode {
    ...
    LOGIN_ALREADY_QQ_AUTHORIZATION(200, "此QQ账号已授权"),
    LOGIN_ALREADY_QQ_NO_AUTHORIZATION(200, "此QQ号码暂未授权"),
    LOGIN_QQ_AUTHORIZATION_ERROR(200, "QQ授权失败，此账户不存在"),
    LOGIN_ERROR_USERNAME_PASSWORD_NOT_BIND_QQ(200, "登录失败，此账户未绑定QQ"),
    USER_QUERY_BANNED_STATE_NO(200, "此账户未被封禁"),
    USER_QUERY_BANNED_STATE_YES(200, "此账户处于封禁状态"),
    //用户注册
    ...
    //账户查封
    USER_QUERY_ACCOUNT_BANNED_ERROR_BY_USERID(200, "查询失败，此用户ID不存在"),
    USER_QUERY_ACCOUNT_BANNED_ERROR_BY_USERNAME(200, "查询失败，此用户名不存在"),
    //登录状态
